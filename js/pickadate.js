...
;(function ($, document, undefined) {
     ...
     */
    Picker = function Picker($ELEMENT, SETTINGS) {
        ...
        P = Picker.prototype = {
            ...
            init: function init() {
                ...
                $ELEMENT.on({
                    'focus click': function focusClick() {
             ...
             */
            setDate: function setDate(year, month, date, isSuperficial) {
             ...
             */
            getDateLimit: function getDateLimit(upper, format) {
             ...
             */
            setDateLimit: function setDateLimit(limit, upper) {
        ...
        DATE_FORMATS = function () {
            ...
            return {
                ...
                toArray: function toArray(format) {
        ...
        TABLE_HEAD = function (weekdaysCollection) {
            ...
            return createNode('thead', createNode('tr', weekdaysCollection.map(function (weekday) {
                return createNode('th', weekday, CLASSES.weekdays);
            })));
        }((SETTINGS.showWeekdaysShort ? SETTINGS.weekdaysShort : SETTINGS.weekdaysFull).slice(0)),
            //TABLE_HEAD
        ...
        function createDateClassAndBinding(loopDate, isMonthFocused) {
            ...
            'data-' + (isDateDisabled ? 'disabled' : 'date') + '=' + [loopDate.YEAR, loopDate.MONTH + 1, // add 1 to display an accurate date
            loopDate.DATE].join('/')];
