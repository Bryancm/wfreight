...
uship.ns('pickadate', function (ns) {
    ...
    function buildOptions() {
        return jQuery.extend({
            ...
            formatSubmit: false,
            today: uship.loc('MyInvToday'),
            clear: uship.loc('Mobile_Find_Clear'),
            firstDay: parseInt(uship.loc('FirstDayOfWeek')),
            dateMin: true,
            dateMax: 179,
    ...
    ns.datebox.prototype = {
        createMinDate: function createMinDate() {
            var minDate;
        ...
        createMaxDate: function createMaxDate() {
            var maxDate;
        ...
        validDateFormat: function validDateFormat(dateEntered) {
        ...
        setDate: function setDate(date, calendarOnly) {
            if (date) {
        ...
        setMinDate: function setMinDate(date, addDays) {
        ...
        setMaxDate: function setMaxDate(date, addDays) {
        ...
        showHideTodayButton: function showHideTodayButton(minDate) {
            if (minDate > moment()) {
        ...
        showTodayButton: function showTodayButton() {
            this.calendarContainer.removeClass('pickadate__holder--noToday');
        },
        hideTodayButton: function hideTodayButton() {
