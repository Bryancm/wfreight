...
;(function (root, ko, $, uship) {
    ...
    var navigateSubObservables = function navigateSubObservables(properties, target) {
    ...
    var referencedObservable = function referencedObservable(property, target, deferred) {
    ...
    var toFormatted = function toFormatted(target, pattern) {
     ...
     */
    var unitsExtender = function unitsExtender(target, units) {
    ...
    var numericBindingHandlerDefault = {
        init: function init(element, valueAccessor, allBindingsAccessor, viewModel, bindingContext) {
            var bindings = valueAccessor(),
                ...
                minValue = allBindings.min,
                maxValue = allBindings.max;
    ...
    var numericBindingHandlerFallback = {
    ...
    // If placeholders aren't supported anyway, keep things simple
    var numericBindingHandler = hasPlaceholder ? numericBindingHandlerDefault : numericBindingHandlerFallback;
    ...
    var slideTemplateBindingHandler = {
        ...
        update: function update(element, valueAccessor, allBindings, viewModel, bindingContext) {
            ...
            $(element).removeClass(classes.toggled).removeClass(classes.afterToggled).removeClass(classes.active);
    ...
    function TransitionState(el, id, classes, toggle, maxDuration) {
        ...
        this.transitionState = $.Deferred().done(this.onEnd.bind(this));
    ...
    var ExternalTemplateEngine = function ExternalTemplateEngine() {
    ...
    var remoteTemplate = function remoteTemplate(templateName, options) {
    ...
    var fetchInstanceTemplate = function fetchInstanceTemplate(template, options) {
     ...
     */
    var StringTemplate = function StringTemplate(text) {
        var _data = {};
        var _text = text;
    ...
    var stringTemplateEngine = function stringTemplateEngine() {
        var _templates = {};
